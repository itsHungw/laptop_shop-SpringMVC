                                    ...
                                    <div class="container-fluid">
                                        ...
                                        <div class="card shadow-lg mb-5 border-0">
                                            <div class="card-header py-3">
                                                <h5 class="card-title mb-0"><i class="fas fa-laptop me-2"></i>Product:
                                                    ${product.name}</h5>
                                            </div>
                                                ...
                                                <div class="row g-0">
                                                    ...
                                                    <div class="col-md-7 p-4 p-lg-5">
                                                        <div
                                                            ...
                                                            <div class="text-end">
                                                                <h3 class="text-primary fw-bold mb-0">$ ${product.price}
                                                                </h3>
                                                                <small class="text-muted">Current Retail Price</small>
                                                            </div>
                                                        </div>
